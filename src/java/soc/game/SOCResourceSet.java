...
public class SOCResourceSet implements Serializable, Cloneable
{
     ...
     *
     * @param a   set A, cannot be <code>null</code>
     * @param b   set B, can be <code>null</code> for an empty resource set
     */
     ...
     *
     * @param a   set A, cannot be <code>null</code>
     * @param b   set B, cannot be <code>null</code>
     */
     ...
     *
     * @param sub  the sub set, can be <code>null</code> for an empty resource subset
     */
