...
public class SOCGame implements Serializable, Cloneable
{
    ...
    /**
     * Minimum version (1.1.17) that supports canceling the second free road placement.
     ...
     * Used with house-rule game option <tt>"N7C"</tt>.
     * @since 1.1.19
     */
     ...
     * Used with house-rule {@link SOCGameOption game option} <tt>"N7C"</tt>.
     *<P>
