...
public class SOCRobotBrain extends Thread
{
    ...
    /**
     * The game messages received this turn / previous turn, for debugging; contents are {@link SOCMessage}.
     * @since 1.1.13
     */
     ...
     * @since 1.1.13
     */
    public List debugPrintBrainStatus()
    {
        ArrayList rbSta = new ArrayList();
        ...
        rbSta.add
            ("Robot internal state: "
             ...
             + " in game " + game.getName() + ": gs=" + game.getGameState());
     ...
     * @since 1.1.13
     */
    private static void debugPrintTurnMessages(Vector msgV, final String msgDesc, final List toList)
    {
     ...
     * Remember that we're sent a {@link SOCGameTextMsg} timing ping once per second,
