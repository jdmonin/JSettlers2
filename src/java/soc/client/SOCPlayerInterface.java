 ...
 * Portions of this file Copyright (C) 2007-2011,2013-2018 Jeremy D Monin <jeremy@nand.net>
 *
...
public class SOCPlayerInterface extends Frame implements ActionListener, MouseListener
{
        ...
        throws IllegalArgumentException
    {
        ...
        {
            int prefWidth = SOCPlayerClient.getUserPreference(SOCPlayerClient.PREF_PI__WIDTH, -1);
            int prefHeight = (prefWidth != -1)
                ? SOCPlayerClient.getUserPreference(SOCPlayerClient.PREF_PI__HEIGHT, HEIGHT_MIN_4PL)
                : 0;
            if (prefWidth != -1)
            {
     ...
     * Uses current size, with scaling factor for 6-player games.
     *<P>
    ...
    private class PIPlaySound implements Runnable
    {
        ...
        public void run()
        {
            if (soundMuted || ! SOCPlayerClient.getUserPreference(SOCPlayerClient.PREF_SOUND_ON, true))
                return;
