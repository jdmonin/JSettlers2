    ...
    PlayerClientListener.NonBlockingDialogDismissListener
{
    ...
    /**
     * Queue a sound to play, currently using the AWT {@link EventQueue}.
     ...
     * @since 1.2.00
     */
    public static void playSound(final byte[] buf)
    {
        if (buf != null)
            EventQueue.invokeLater(new PIPlaySound(buf));

        // TODO use a dedicated queue/thread
    }
     ...
     *<P>
     * Suitable for use with {@link EventQueue#invokeLater(Runnable)}
     * or other multithreading schemes.
     * @since 1.2.00
     */
    private static class PIPlaySound implements Runnable
    {
