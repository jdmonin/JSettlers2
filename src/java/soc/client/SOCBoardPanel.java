 ...
 * Portions of this file Copyright (C) 2007-2016,2018 Jeremy D Monin <jeremy@nand.net>
 *
...
public class SOCBoardPanel extends Canvas implements MouseListener, MouseMotionListener
{
        ...
        if (player != null)
        {
            ...
            else if (cpn == playerNumber)
            {
                ...
                case SOCGame.PLAY:
                    ...
                    {
                        topText = "No 7s rolled until a city is built";
                    }
                    break;
    ...
    protected class BoardToolTip
    {
         ...
         */
        public void positionToMouse(final int x, final int y)
        {
            mouseX = x;
            mouseY = y;
         ...
         */
        private void handleHover(final int x, final int y)
        {
            ...
            /** If we're hovering at a node port, store its coordinate here and also set {@link #nodePortDesc} */
            int nodePortCoord = -1;
            ...
            if (nodePortCoord != -1)
            {
                if ((hoverMode == PLACE_INIT_SETTLEMENT) && (hoverID == id) && hoverIsPort)
                {
