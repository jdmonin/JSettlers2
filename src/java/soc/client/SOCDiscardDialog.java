 ...
 * Portions of this file Copyright (C) 2007-2009,2011-2012,2017 Jeremy D Monin <jeremy@nand.net>
 *
...
class SOCDiscardDialog extends Dialog implements ActionListener, MouseListener
{
     ...
     *<P><em>Backported to 1.1.14 from 2.0.00</em>
     * @since 1.1.14
     */
    ...
    public void setVisible(boolean b)
    {
        if (b)
        {
            ...
            playerInterface.playSound(SOCPlayerInterface.SOUND_RSRC_LOST);
        }
