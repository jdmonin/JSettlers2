    ...
    implements Runnable, ActionListener, TextListener, ItemListener, MouseListener
{
     ...
     * The {@code SOCPlayerClient} constructor will call {@link #clearUserPreferences(String)}.
     *<P>
     ...
     *<P>
     * For games with 6 players, a scaling factor is applied to this preference
    ...
    public SOCPlayerClient(String h, int p, boolean cp)
    {
        ...
        if (debug_clearPrefs != null)
            clearUserPreferences(debug_clearPrefs);
    }
     ...
     * <em>Backported from 2.0.00 to 1.1.14.</em>
     *
     * @param s  the message
     * @return true if the message was sent, false if not
     * @see #put(String, boolean)
    ...
    /**
     * Write a message to the net or local practice server.
    ...
    protected void handleGAMES(SOCGames mes, final boolean isPractice)
    {
        ...
        if (! isPractice)  // practice srv's gameoption data is set up in handleVERSION
        {
            if (serverGames == null)
     ...
     *     as {@link #PROP_JSETTLERS_DEBUG_CLEAR__PREFS}.
