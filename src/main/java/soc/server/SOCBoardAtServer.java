...
public class SOCBoardAtServer extends SOCBoardLarge
{
     ...
     * Called by {@link SOCBoardAtServer.BoardFactoryAtServer#createBoard(SOCGameOptionSet, int)}
    ...
    {
        final boolean isSea = (opts != null) && opts.isOptionSet("SBL");  // if false ,is classic 4- or 6-player board
        final SOCGameOption opt_breakClumps = (opts != null ? opts.get("BC") : null);

        SOCGameOption opt = (isSea && (opts != null)) ? opts.get(SOCGameOptionSet.K_SC_FOG) : null;
     ...
     * {@link BoardFactoryAtServer#createBoard(SOCGameOptionSet, int) BoardFactoryAtServer.createBoard}:
    ...
    {
        final boolean isSea = (gameOpts != null) && gameOpts.isOptionSet("SBL");
        int heightWidth = 0;
        ...
        (final SOCGameOptionSet gameOpts)
    {
        ...
        if (scen.length() == 0)
        {
            if ((gameOpts != null) && gameOpts.isOptionSet("SBL"))
