 ...
 * Portions of this file Copyright (C) 2009-2012,2014,2016-2017,2019-2021 Jeremy D Monin <jeremy@nand.net>
    ...
    implements SOCMessageForGame
{
    ...
    {
        Message.GameMembers.Builder b = Message.GameMembers.newBuilder()
            .setGaName(game)
            .addAllMembers(members);
        return Message.FromServer.newBuilder()
            .setGaMembers(b).build();
    }
