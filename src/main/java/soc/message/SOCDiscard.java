    ...
    implements SOCMessageForGame
{
    ...
    public String toCmd()
    {
        return DISCARD + sep + game + sep2
            ...
            + resources.getAmount(Data.ResourceType.CLAY_VALUE) + sep2
            + resources.getAmount(Data.ResourceType.ORE_VALUE) + sep2
            + resources.getAmount(Data.ResourceType.SHEEP_VALUE) + sep2
            + resources.getAmount(Data.ResourceType.WHEAT_VALUE) + sep2
            + resources.getAmount(Data.ResourceType.WOOD_VALUE) + sep2
            + resources.getAmount(Data.ResourceType.UNKNOWN_VALUE);
    }
    ...
    protected Message.FromServer toProtoFromServer()
    {
        ...
        b.setLose(ProtoMessageBuildHelper.toResourceSet(resources));
