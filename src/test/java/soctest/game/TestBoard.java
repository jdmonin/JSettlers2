...
public class TestBoard
{
    ...
    @Ignore("JSettlers v3 uses only SOCBoardLarge; SOCBoard4p is abstract")
    @Test
    public void test_getNodeBetweenAdjacentEdges()
    {
        SOCBoard b = null;  // null because junit compiles this even though it's ignored/skipped
           // = new SOCBoard4p(null);  // SOCBoard4p and SOCBoard6p use same geometry methods in base SOCBoard
